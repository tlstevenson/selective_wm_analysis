...
all_sess['delay_time'] = all_sess['delay_time'].round(4)
all_sess['stim_dur'] = all_sess['stim_dur'].round(4)

# get delay and stimulus duration bins
bin_size = 1
...
all_sess['delay_bin'] = all_sess['delay_time'].apply(
...
all_sess['delay_bin'] = pd.Categorical(all_sess['delay_bin'], categories=delay_bin_labels)
...
count_columns = ['correct_port', 'stim_dur_bin', 'delay_bin', 'tone_info_side', 'tone_info_pitch']
...
bah.plot_counts(count_dict['tone_info_side'], axs[3], 'Stimulus Side', '# Trials', 'h')
bah.plot_counts(count_dict['tone_info_pitch'], axs[4], 'Stimulus Pitch', '# Trials', 'h')
...
bah.plot_counts(count_dict_pct['tone_info_side'], axs[3], 'Stimulus Side', '% Trials', 'v')
bah.plot_counts(count_dict_pct['tone_info_pitch'], axs[4], 'Stimulus Pitch', '% Trials', 'v')
...
# plot combined performance - # tones-same/diff by stimulus length
if combine_subjects:
